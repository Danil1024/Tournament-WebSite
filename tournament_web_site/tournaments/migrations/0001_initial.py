# Generated by Django 5.1.3 on 2025-07-02 07:38
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message="Никнейм может содержать только латинские буквы, цифры и знак подчёркивания",
                                regex="^[A-Za-z ]+$",
                            )
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Оставьте пустым, чтобы установить автоматически",
                        null=True,
                ...
                (
                    "start_date",
                    models.DateTimeField(verbose_name="Дата начала турнира"),
                ),
                (
                    "team_size",
                    models.CharField(
